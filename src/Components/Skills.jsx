...
const Skills = () => {
  ...
  return (
    <section id="skills">
      ...
      >
        <h1>My </h1> <h1 style={{ color:"var(--color-font)"}} >Techinal Skills</h1>
        
      </Flex>
      <Flex m="auto" w={400} mb={"60px"} justifyContent={"space-evenly"}>
       <button onClick={()=>setTech("all")}>ALL</button>
       <button onClick={()=>setTech("frontend")}>FRONTEND </button>
       <button onClick={()=>setTech("backend")}>BACKEND</button>
      </Flex>
      <div id="skillsdiv">
        {tech==="all"?skillsarr.map((el) => (
          <div
            data-aos="fade-down-right"
            data-aos-duration="4000"
            data-aos-delay="300"
