...
export const grow = [
  {
    ...
    des: `
      Chargebee is the subscription billing and revenue management platform that consts you solve for your today, and scale for your tomorrow`,
    title: "ChargeBee",
    techstack: [
      { src: html, name: "HTML" },
      { src: css, name: "CSS" },
